 ...
 */
public class Futebol extends Distancia implements Serializable{
    ...
    public Futebol(int tempo,String metereologia,GregorianCalendar data,double distancia,double velocidade_maxima)
    {
        super(tempo,metereologia,data,distancia,velocidade_maxima);
    }

    public Futebol(Futebol a)
    {
        super(a);
    }
