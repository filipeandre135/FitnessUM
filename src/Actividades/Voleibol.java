 ...
 */
public class Voleibol extends Estacionaria implements Serializable{
    ...
    public Voleibol(int tempo,String metereologia,GregorianCalendar data,double distancia,double velocidade_maxima)
    {
        super(tempo,metereologia,data);
    }

    public Voleibol(Voleibol a)
    {
        super(a);
    }
    ...
    public Voleibol clone(){return new Voleibol(this);}
