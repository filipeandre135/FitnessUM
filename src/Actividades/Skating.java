 ...
 */
public class Skating extends Distancia implements Serializable{
    ...
    public Skating(int tempo,String metereologia,GregorianCalendar data,double distancia,double velocidade_maxima)
    {
        super(tempo,metereologia,data,distancia,velocidade_maxima);
    }

    public Skating(Skating a)
    {
        super(a);
    }
