 ...
 */
public class Corrida extends Distancia implements Serializable
{
    ...
    public Corrida(int tempo,String metereologia,GregorianCalendar data,double distancia,double velocidade_maxima)
    {
